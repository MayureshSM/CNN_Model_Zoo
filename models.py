...
class Object_classification():
    ...
    def _modelrun(self,img,model):
        ...
        print(classes[np.argsort(np.array(res.detach()[0])).astype(int)[-1] ])
    
    
    def resnet50(self,img): 
        model=resnet50(pretrained=True, progress=True)
        self._modelrun(img,model)
...
img=plt.imread("/storage/emulated/0/Documents/Repos/Images/images5.jpg")
